...
//
//	void SetComponents(TransformComponent* pTransformComp, TextureTransformComponent* pTextureTransformComp, RenderComponent* pRenderComp);
//
//private:
//	TileName m_Name;
...
//	TextureTransformComponent* m_pTextureTransformComp;
